...
SPREADSHEET_ID = '1yEKmYtzW0gAxehkRNMNECFQF3Gtb3Y4cbyAGNFSY7bc' 
#SPREADSHEET_ID = '1EwiQgKYDwJF1nL0QrHBOLwGJWaipUKLuYP5ZzlCNhe4' #demanda colectiva

PARENT_FOLDER_ID = '1IW9SuKynd2QEw5N0bOqq_YBCj4HAHxlC' 
...
def eliminar_puntos_cedula(cedula):
    ...
    return str(cedula)
def get_client_by_cedula(sheets_service, spreadsheet_id, sheet_name, cedula,CEDULA_COLUMN=CEDULA_COLUMN):
    """
